...
- [x] End-to-end smoke на preview-деплое выполнен: `/start` + текстовое сообщение dev-боту → 4 строки в `messages`, 1 в `conversations`, 1 в `users`. Журнал заполнен в `.ai-factory/Journal/preview-deploy-vercel.md`.
