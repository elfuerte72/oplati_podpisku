...
name: full-audit
description: >
  Аудит ВСЕГО проекта oplati_podpicky роем агентов через Workflow: 12 осей от
  БД-инвариантов и платежей до рефералки и полноты тестов, находки проходят
  адверсариальную верификацию. Отчёт с file:line и сценариями отказа.
  Use when: «полный аудит», «проверь весь проект», «рой агентов».
  NOT for: diff/ветку/PR (full-review), дизайн (oplatishka-design), правку кода.
---
