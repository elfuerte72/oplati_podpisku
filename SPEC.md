...
- **D-REF-1 `[confirmed]` — пороги и ставки.** Канон — раздел 4 (круги): пороги $500/$2000/$5000, ставки L1 4/6/7%. **Подтверждено владельцем 2026-06-30** — статус «Партнёр» (6%) даётся при обороте **$2000** (раздел 4), НЕ $500 (противоречащий раздел 3). Ставки воспроизводят worked-примеры документа дословно (см. §3 проверку). Таблица ставок — §3.
