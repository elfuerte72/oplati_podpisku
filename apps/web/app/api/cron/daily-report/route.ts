...
/**
 * Дневной отчёт в тему «Отчёты» ops-группы. Расписание — раз в сутки в 09:00
 * по Москве (`infra/crontab.example`): без параметров отчёт за вчерашний
 * календарный день. `?day=YYYY-MM-DD` — ручная переотправка за нужную дату
 * (сегодняшняя помечается как неполная).
 */
