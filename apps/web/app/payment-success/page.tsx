    ...
    <main className="grid min-h-dvh place-items-center p-6">
      ...
      >
        ...
        <p className="mt-5 text-[15px] leading-relaxed text-[var(--text)]">
          Виртуальная карта придёт <strong>в Telegram</strong> в течение пары минут.
          Последний шаг делаешь ты: оплатишь этой картой подписку на сайте
          сервиса, в своём аккаунте.
        </p>

        <p className="mt-3 text-sm text-[var(--text-muted)]">
          Реквизиты карты приходят только в Telegram — на этой странице их не будет.
        </p>
