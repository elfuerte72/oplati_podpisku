...
/**
 * Блок пер-сервисных правил оплаты картой на сайте сервиса (ТЗ §5). Заголовок
 * называет, О КАКОЙ оплате речь: блок стоит и до оплаты заказа, и прежнее
 * «Важно перед оплатой» читалось как «включи VPN перед оплатой рублями»
 * (разбор пути клиента 2026-09-23). VPN не
  ...
  return (
    ...
    >
      <p className="font-display text-xs font-bold uppercase tracking-wide text-[var(--text)]">
        Когда будешь платить картой на сайте сервиса
      </p>
      {points ? (
        <>
