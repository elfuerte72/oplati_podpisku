 ...
 * (`/mascot/hero.webp`, Higgsfield, «нарисовывается» через intro-draw-in),
...
const STEPS: { title: string; text: string }[] = [
  {
    title: 'Выбери сервис и оплати рублями',
    text: 'Российской картой или через СБП. Полную итоговую сумму увидишь до оплаты.',
  },
  {
    title: 'Получи виртуальную карту',
    text: 'Выпустим карту и пополним её на сумму подписки — реквизиты придут в кабинет и в Telegram.',
  },
  {
    title: 'Оплати подписку на своём аккаунте',
    text: 'Введи реквизиты карты на сайте сервиса. Пароль передавать не нужно — аккаунт остаётся у тебя.',
  },
];
