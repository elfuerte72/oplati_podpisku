 ...
 *   - `messages` (переписка) старше `MESSAGES_RETENTION_DAYS` — удаляются
 *     (90 дней по решению 2026-07-19, с 2026-09-09 — 730: переписка нужна
 *     для обучения агента поддержки);
