...
| [`plan-freekassa-integration.md`](plan-freekassa-integration.md) | ТЗ на вторую платёжную систему: **работа не начата**, на проде только L&P | беретесь за Freekassa; после исполнения файл уезжает в `history/` |
