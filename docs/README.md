...
| [`reference/smm-agent.md`](reference/smm-agent.md) | SMM-канал @ooplatishka после вывода Гилфойла (2026-09-22): что осталось живым, что переиспользовать в новом боте, что учесть |
...
- `hermes-agent-monitoring.md` + `hermes/` — агент Гилфойл, который до 2026-09-04 вёл
  мониторинг и слал алёрты своим ботом. Выведен из контура треком ops-group (уведомления
  забрала ops-группа), профиль владелец оставил под SMM канала. ⚠️ Описанный там шлюз
  остановлен, ключи и токены удалены — как ТЗ не использовать;
- `smm-agent-hermes.md` — тот же Гилфойл в роли SMM-агента канала (2026-09-04 → 2026-09-22):
  очередь, линт, судья, публикация через `sendRichMessage`. Выведен 2026-09-22, установка
  и профиль — в архиве на бостонском VPS; актуальное — `reference/smm-agent.md`.
