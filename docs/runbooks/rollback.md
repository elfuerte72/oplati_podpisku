...
| **squid-прокси** `177.7.34.106:24128` | сразу — приложение не ходит через него (`LOVEANDPAY_PROXY_URL` не задан, egress прямой с задекларированного IP) | погасить сервис, снять ACL |
