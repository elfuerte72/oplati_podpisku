 ...
 * ⚠️ Про личный кабинет здесь НЕ обещаем: адрес нигде не хранится, и кабинет
 * его не показывает (до 2026-09-21 текст это обещал — неправда; BACKLOG).
 */
const US_BILLING_INSTRUCTIONS =
  'В Billing Address введи данные адреса США — они придут вместе с реквизитами карты в Telegram.';
