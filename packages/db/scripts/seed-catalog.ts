...
const CATALOG: readonly CatalogEntry[] = [
  ...
  // ─── Social ──────────────────────────────────────────────────────────────────
  {
    // Возвращён из архива по решению владельца 2026-07-03. Месячный тариф
    // поднят $4.99 → $5.20 (2026-07-04): при $4.99 он давал 499,50 ₽ — НИЖЕ
    // минимума терминала L&P (500 ₽) и не показывался в витрине
    // (buildCatalogService отсекает тарифы дешевле порога). $5.20 при
    // fallback-курсе 77 и комиссии 30% даёт 520,52 ₽ — проходит. Годовой — $35.99.
    slug: 'telegram-premium',
    name: 'Telegram Premium',
    description: 'Telegram Premium — расширенные возможности мессенджера',
    category: 'social',
    requiresKyc: false,
    pricingPolicy: policy([usd('Premium', 5.2), usd('Premium', 35.99, 'year')]),
  },
];
