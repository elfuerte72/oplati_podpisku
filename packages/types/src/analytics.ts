...
export const ANALYTICS_EVENTS = {
  ...
  bot_text_ignored: {
    title: 'Написал в бота, а бот промолчал',
    description:
      'Клиент отправил текст или медиа при выключенном BOT_AI_ENABLED — бот намеренно не отвечает. Единственный способ увидеть эту потерю: в логах и БД её нет.',
    channel: 'bot',
    origin: 'server',
    props: ['kind', 'len'],
  },
